...
class MoveTest(BaseTest):
    ...
    def test_move_unpublished_text_file(self, m_fetch, m_get_current_user):
        self.create_test_user(m_get_current_user)
        self.text_content = """Just text"""
        self.from_path = '/simple.txt'
        self.to_path = '/moved_simple.txt'
        ...
        def fetch_mock(request, callback, **kwargs):
            ...
            if "api.dropbox.com/1/fileops/move" in request.url and\
        ...
        self.assertEqual(from_meta_in_db, None)
