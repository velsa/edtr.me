...
//
var modalDialog = {
    filename_with_correct_ext:  null,

    modal_check_filename_input:     function(){
        ...
        if ($('.modal-filename-input')[0]) {
            ...
            if ($('.modal-filename-input-add-on')[0]) {
                ...
                if (ext != null) {
                    ...
                    this.filename_with_correct_ext +=
    ...
    show_file_modal:                function() {
        ...
        //     "/static/html/home_modals.html?reload="+(new Date()).getTime()+
        ...
        //         }
                ...
                $('.modal').on("shown", function() {
                    ...
                    modalDialog.modal_check_filename_input();
                });
                ...
                $('.modal-submit-button').click(function() {
                    if (this.modal_check_filename_input()){
                        $('.modal').modal('hide');
                        $.post('/async/do_dropbox/', {
                            ...
                            filename:       this.filename_with_correct_ext
                        }, function(data) {
